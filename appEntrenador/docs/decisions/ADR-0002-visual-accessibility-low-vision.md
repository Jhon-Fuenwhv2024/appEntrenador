...
ADR-0001 sigue vigente para CTAs `on-primary`/`on-success` y overlays de menú. ADR-0002 **extiende** el alcance a muted, focus, zoom, **escala tipográfica del sistema/in-app** y targets; no sustituye ADR-0001.
