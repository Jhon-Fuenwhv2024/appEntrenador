...
- [x] Trainer: 4 ítems en bottom nav y sidebar (Inicio, Alumnos, Biblioteca, Ajustes)
- [x] Ítem “Ejercicios” ya no es destino de primer nivel en la barra
- [x] Rutas placeholder de Biblioteca y Ajustes no rompen auth ni muestran 404 crudo (vista “próximamente” o shell vacío documentado)
- [x] Ficha `/trainer/clients/:clientId` sigue siendo contexto (no ítem de barra); puede marcar Alumnos como activo
- [x] Client: sin cambios de IA salvo lo necesario para no romper el shell compartido
- [x] Logout permanece fuera de los 4 slots (header móvil / pie sidebar)
- [x] `npm run build` frontend OK; `docs/architecture.md` y `docs/RESPONSIVE.md` actualizados
