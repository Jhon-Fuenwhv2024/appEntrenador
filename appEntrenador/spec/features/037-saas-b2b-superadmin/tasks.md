# Tasks — 037 SaaS B2B Superadmin

> Ops fuera de Fase 1 / SQL manual: documentado como aceptado.
...
- [x] Pagos automatizados / portal facturación (fuera de alcance Fase 1)
- [x] Validar build + arranque backend (`ensureSaasColumns`; `/api/saas` responde 401 sin token)
- [x] (Manual dueño) `UPDATE usuarios SET is_superadmin = TRUE WHERE id = <TU_ID>` + re-login
