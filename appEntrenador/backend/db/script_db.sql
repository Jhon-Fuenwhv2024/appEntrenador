...
CREATE TABLE rutinas (
    ...
    assignment_id INT NULL COMMENT 'Feature 091: linaje a client_program_assignments',
    program_day_id INT NULL COMMENT 'Feature 091: día de programa materializado',
    source_week_index TINYINT NULL COMMENT 'Feature 091: microciclo materializado',
...
CREATE TABLE exercises (
    ...
    primary_muscle VARCHAR(100) NULL COMMENT 'Músculo principal (taxonomía HITL)',
    secondary_muscles JSON NULL COMMENT 'Músculos secundarios (array JSON de strings)',
...
CREATE TABLE workout_sessions (
    ...
    assignment_id INT NULL COMMENT 'Feature 091',
    program_week_index TINYINT NULL COMMENT 'Feature 091',
...
-- Feature 083: adherencia Comí / No comí
CREATE TABLE diet_meal_adherence (
    id INT AUTO_INCREMENT PRIMARY KEY,
    client_id INT NOT NULL,
    diet_meal_id INT NOT NULL,
...
-- 22. PERIODIZACIÓN (Feature 091): Macro → Meso → Micro → Sesión
